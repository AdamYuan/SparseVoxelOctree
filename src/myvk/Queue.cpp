...
namespace myvk {
std::shared_ptr<Queue> Queue::create(const std::shared_ptr<Device> &device, uint32_t family_index,
...
VkResult Queue::WaitIdle() const { return vkQueueWaitIdle(m_queue); }

std::shared_ptr<PresentQueue> PresentQueue::create(const std::shared_ptr<Device> &device,
