...
void AtomicCounter::Initialize(const std::shared_ptr<myvk::Device> &device) {
...
void AtomicCounter::Reset(const std::shared_ptr<myvk::CommandPool> &command_pool, uint32_t value) {
