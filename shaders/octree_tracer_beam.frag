...
layout (push_constant) uniform uuPushConstant { uint uWidth, uHeight, uBeamSize; float uOriginSize, uDirSize; };
...
void main() {
	...
	float t; oFragT = RayMarchCoarse(o, d, uOriginSize, uDirSize, t) ? t : 1e10;
}
