...
void ImGui::StyleColorsVisualDark(ImGuiStyle *dst)
{
	// Posted by @mnurzia here: https://github.com/ocornut/imgui/issues/2529
...
static const unsigned char*  GetDefaultCompressedFontDataTTF();
...
ImFont* ImFontAtlas::AddFontDefault(const ImFontConfig* font_cfg_template)
{
    ...
    if (font_cfg.SizePixels <= 0.0f)
        font_cfg.SizePixels = 19.0f * 1.0f; //default font size
